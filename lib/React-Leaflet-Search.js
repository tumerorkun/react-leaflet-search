...
var ReactLeafletSearch = function (_MapControl) {
    ...
    ReactLeafletSearch.prototype.latLngHandler = function latLngHandler(latLng, info, raw) {
        // console.log(latLng, info, raw)
        this.SearchInfo = { info: info, latLng: latLng, raw: raw };
...
ReactLeafletSearch.propTypes = {
    ...
    customProvider: _propTypes2.default.oneOfType([_propTypes2.default.bool, _propTypes2.default.func, _propTypes2.default.object])
};
