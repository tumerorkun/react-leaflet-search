...
var ReactLeafletSearch = function (_MapControl) {
    ...
    ReactLeafletSearch.prototype.latLngHandler = function latLngHandler(latLng, info) {
        ...
        var popUpStructure = _react2.default.createElement(
            ...
            _react2.default.createElement(
                'p',
                null,
                Array.isArray(info) ? info.toString() : info.name
            ),
    ...
    ReactLeafletSearch.prototype.goToLatLng = function goToLatLng(latLng, popup, info) {
        var _this3 = this;

        this.setState({ search: latLng, popup: popup, info: info }, function () {
            _this3.flyTo();
        });
    };
