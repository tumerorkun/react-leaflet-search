...
exports.OpenStreetMap = undefined;
...
var OpenStreetMap = function () {
  ...
  OpenStreetMap.prototype.formatResponse = function formatResponse(response) {
    ...
    var info = count > 0 ? resources.map(function (e) {
      return {
        bounds: new _leaflet.LatLngBounds(new _leaflet.LatLng(e.boundingbox[0], e.boundingbox[2]), new _leaflet.LatLng(e.boundingbox[1], e.boundingbox[3])),
